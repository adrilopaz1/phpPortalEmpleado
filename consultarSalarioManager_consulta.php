<?php
	...
	function title($id, $db){
		...
		$sql1=" select employees.first_name, salary, from_date, to_date from salaries, employees where salaries.emp_no=employees.emp_no and salaries.emp_no=$id and to_date='9999-01-01'";
