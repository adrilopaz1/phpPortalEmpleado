<?php
	...
	function title($id, $db){
		...
		$sql1=" select employees.first_name, dept_no, from_date, to_date from dept_emp, employees where dept_emp.emp_no=employees.emp_no and employees.emp_no=$id and dept_emp.to_date='9999-01-01'";
